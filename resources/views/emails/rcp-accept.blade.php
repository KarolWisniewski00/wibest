...
<head>
    ...
    <title>Zadanie zaakceptowane</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Zadanie zaakceptowane</h1>
        </div>

        <div class="invoice-details" style="text-align: center;">
            <h2>{{ $work_session->user->name }}, twóje zadanie zostało zaakceptowane</h2>
            <p style="font-weight: bold;">{{ $work_session->task->note }}, {{ $work_session->task->time }}</p>
        </div>
