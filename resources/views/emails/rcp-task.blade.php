...
<body>
    <div class="container">
        ...
        <div class="invoice-details" style="text-align: center;">
            <h2>{{ $work_session->user->supervisor->name }}, pojawiło się nowe zadanie</h2>
            <p style="font-weight: bold;">{{ $work_session->user->name }}, {{ $work_session->task->note }}, {{ $work_session->task->time }}</p>
        </div>
