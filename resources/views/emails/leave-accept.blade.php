...
<head>
    ...
    <title>Wniosek zaakceptowany</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Wniosek zaakceptowany</h1>
        </div>

        <div class="invoice-details" style="text-align: center;">
            <h2>{{ $leave->user->name }}, twój wniosek został zaakceptowany</h2>
            <p style="font-weight: bold;">{{ $leave->type }}, {{ $leave->status }}, {{ $leave->start_date }} {{ $leave->end_date }}</p>
        </div>
