            ...
            @foreach($days as $day)
                <li class="flex items-center justify-center h-full">
                    ...
                    <label for="start-{{ $day['id'] }}"
                        class="flex flex-col items-center justify-center h-full w-full text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl shadow-md cursor-pointer peer-checked:border-green-400 dark:peer-checked:border-green-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 p-2">
