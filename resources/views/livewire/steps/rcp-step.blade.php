    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input
                ...
                type="hidden"
                class="" />
            <!--:workSessionId="app()->make(\App\Repositories\WorkSessionRepository::class)->getFirstRcp($this->getState()['user_id'], $this->getState()['date_edit'])->id ?? null"-->
            <livewire:calendar-from-to-auto
                type="first"
                work_session="true"
                :workSessionId="$this->getState()['work_session_id'] ?? null"
                calendar="single"
