                ...
                <div class="items-center hidden sm:flex xl:hidden 2xl:flex">
                            ...
                            <x-flex-center>
                                <x-paragraf-display class="text-xs font-bold text-gray-900 dark:text-white">
                                    <div class="flex flex-row gap-1 justify-start items-center">
                                        <div class="text-md mx-2">{{ config('leavetypes.icons.' . $date['leave'], '') }}</div>
                    ...
                    <x-widget-display-nav class="grid-cols-3 grid-rows-1 gap-4 p-2 m-2 w-full">
                        <div class="col-span-2">
                            ...
                            <div class="">
                                <x-flex-center>
                                    <div id="loaderDate" class="h-4 rounded-lg bg-gray-200 dark:bg-gray-600 w-16 mx-auto animate-pulse">
                                    </div>
                            ...
                            <div>
                                <x-flex-center>
                                    <div id="loaderClock" class="h-4 mt-2 rounded-lg bg-gray-200 dark:bg-gray-600 w-12 mx-auto animate-pulse">
                                    </div>
                        ...
                        <div class="col-start-3 h-full">
                            ...
                            <div class="text-center flex justify-center items-center h-full">
                                <div id="loaderTimer" class="h-[34px] rounded-lg bg-gray-200 dark:bg-gray-600 w-[94px] mx-auto animate-pulse">
                                </div>
                                <button
                                    id="startButton"
