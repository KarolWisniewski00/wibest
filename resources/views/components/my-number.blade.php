<div x-data="wireui_inputs_number({
    ...
    <x-dynamic-component
        ...
        inputmode="numeric"
        {{ $attributes
            ->class('text-center appearance-number-none dark:bg-gray-700')
            ->except('wire:key')
            ->except($except) }}
        ...
        <x-slot name="prepend">
            <div class="absolute inset-y-0 left-0 flex items-center p-0.5">
                <x-dynamic-component
                    ...
                    class="h-full rounded-l-md dark:text-white dark:hover:bg-gray-600"
                    icon="minus"
                    primary
                    flat
                    squared
        ...
        <x-slot name="append">
            <div class="absolute inset-y-0 right-0 flex items-center p-0.5">
                <x-dynamic-component
                    ...
                    class="h-full rounded-r-md dark:text-white dark:hover:bg-gray-600"
                    icon="plus"
                    primary
                    flat
                    squared
