<x-app-layout>
                ...
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="mt-8">
                        ...
                        <form method="POST" action="{{ route('offer.store') }}" class="mt-6">
                            ...
                            <!-- Numer oferty -->
                            <div class="mb-6">
                                <label for="number" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Numer oferty</label>
                                <input type="text" id="number" name="number" value="{{ $offerNumber }}" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">
                                @error('number')
                            ...
                            <div class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input type="text" id="buyer_person_name" name="buyer_person_name" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input type="text" id="buyer_person_email" name="buyer_person_email" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">
                            ...
                            <!-- Pozycje oferty -->
                            <div class="mb-6">
                                <h3 class="text-sm md:text-xl font-medium text-gray-900 dark:text-gray-100">Pozycje na ofertze</h3>
    ...
    `);
        ...
        function offerItems() {
            ...
            // Funkcja do dodawania nowych pozycji na ofertze
        ...
        function updateInvoiceNumberPrefix() {
            ...
            var selectedType = $('input[name="offer_type"]:checked').attr('id'); // Pobiera id wybranego typu oferty

            if (selectedType === 'offer') {
                prefix = 'FVS'; // Domyślny przedrostek dla oferty
            } else if (selectedType === 'proform') {
                prefix = 'FVP'; // Przedrostek dla oferty proforma
            } else if (selectedType === 'correct') {
                prefix = 'FVK'; // Przedrostek dla oferty korygującej
            }

            // Aktualizacja wartości inputa z numerem oferty
