                    ...
                    <div class="px-4 h-14 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                        <nav class="flex gap-x-8 h-full" aria-label="Tabs" role="tablist" aria-orientation="horizontal">
                            <x-nav-link class="h-full text-center"
                                href="{{ route('leave.group.index') }}"
                                :active="Str::startsWith(request()->path(), 'dashboard/leave/group')">
                                Zgrupowane
                            </x-nav-link>
                            <x-nav-link class="h-full text-center"
                            ...
                            <x-nav-link class="h-full text-center"
                                href="{{ route('leave.limit.index') }}"
                                :active="Str::startsWith(request()->path(), 'dashboard/leave/limit')">
                                Użycie i limity
                            </x-nav-link>
                        </nav>
                    </div>
