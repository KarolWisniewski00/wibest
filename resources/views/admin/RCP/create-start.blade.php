    ...
    @if ($company)
        ...
        <x-sidebar-left>
            <li>
                <div class="p-2 text-sm text-blue-300 rounded-lg dark:text-blue-300">
                    Tworzysz nową sesję RCP z statusem w trakcie pracy.
                </div>
            </li>
            <li>
        ...
        <x-main>
            ...
            <div class="p-4">
                ...
                <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-50 mb-4 text-center">Nowa Praca RCP</h2>
                <!--POWRÓT-->
                <span>
                    @csrf
                    <livewire:rcp-start-wizard />
                </span>
            </div>
            <!--CONTENT-->
        </x-main>
