<x-app-layout class="flex">
    ...
    <x-main-no-filter>
        ...
        <x-container-content-form>
            ...
            <!--POWRÓT-->
            <form id="myForm" method="POST" action="{{ route('setting.blog.store') }}" class="space-y-4">
                @csrf
                <style>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="short_description" name="short_description" rows="4"
                        ...
                        class="mt-1 block w-full p-3 border border-gray-300 rounded-md shadow focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">{{ old('short_description') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="seo_description" name="seo_description" rows="4" placeholder="Opis dla Google..."
                        class="mt-1 block w-full p-3 border border-gray-300 rounded-md shadow focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">{{ old('seo_description') }}</textarea>
                ...
                <div class="mt-2">
                    ...
                    <select id="type" name="type" autocomplete="off" class="mt-2 rounded-lg text-lg">
                        ...
                        <option value="Polityka cookies">Polityka cookies</option>
                    </select>
                </div>
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <div id="preview"style='font-family: "Lato", sans-serif;' class="flex flex-col items-start justify-between gap-4 mb-8">
                            </div>
                        </div>
                    </div>
                </div>
