                ...
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <form method="POST" action="{{ route('setting.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" autofocus required class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">
                            @error('name')
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="adress" name="adress" value="{{ old('adress') }}" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">
                            @error('adress')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex flex-col relative mb-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <input type="text" id="vat_number" name="vat_number" value="{{ old('vat_number') }}" class="min-h-[44px] mt-1 block w-full p-2 border bg-gray-100 text-gray-700 border-gray-100 rounded-r-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" required>
                            </div>
                            @error('vat_number')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
