        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8 bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <!--FORMULARZ-->
                    <div class="mt-8">
                        <h1 class="text-5xl text-center font-medium text-gray-700 dark:text-gray-100">Wystaw fakturę</h1>
                        ...
                        <form id="my-form" method="POST" action="{{ route('invoice.store') }}" class="mt-6">
                            ...
                            <div class="mb-6">
                                ...
                                <ul class="grid w-full gap-6 md:grid-cols-2">
                                    <li>
                                        <input name="invoice_type" type="radio" id="invoice" value="faktura sprzedażowa" class="hidden peer" checked>
                                        <label for="invoice" class="text-center h-full flex flex-col gap-4 items-center justify-between w-full p-5 text-gray-400 bg-white border-2 border-gray-100 rounded-lg cursor-pointer peer-checked:text-gray-700 peer-checked:bg-gray-100 peer-checked:border-blue-500 hover:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 peer-checked:dark:border-blue-600 dark:hover:text-gray-50 dark:peer-checked:text-gray-50 dark:peer-checked:bg-gray-700">
                                            ...
                                            <div class="grid grid-cols-3 grid-rows-2 gap-4 w-full h-full">
                                                ...
                                                <div class="col-span-2 row-span-2 text-start flex flex-col items-center justify-center">
                                                    ...
                                                    <p class="text-green-500 dark:text-green-500 w-full">
                                                        Dokument księgowy
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <label for="proform" class="text-center h-full flex flex-col gap-4 items-center justify-between w-full p-5 text-gray-400 bg-white border-2 border-gray-100 rounded-lg cursor-pointer peer-checked:text-gray-700 peer-checked:bg-gray-100 peer-checked:border-blue-500 hover:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 peer-checked:dark:border-blue-600 dark:hover:text-gray-50 dark:peer-checked:text-gray-50 dark:peer-checked:bg-gray-700">
                                            <div class="grid grid-cols-3 grid-rows-2 gap-4 w-full h-full">
                                                <div class="row-span-2 h-full flex flex-col justify-center items-center">
                                ...
                                <ul class="grid w-full gap-6 md:grid-cols-2">
                                    <li>
                                        <div class="flex flex-col gap-4 w-full h-full appearance-none rounded-lg border border-gray-100 dark:border-gray-700 bg-gray-100 p-4 outline-none  dark:bg-gray-700 dark:text-gray-50">
                                            <div class="md:grid md:gap-4 py-4 border-b border-gray-100 dark:border-gray-700">
                                                <p class="text-gray-700 dark:text-gray-300 test-sm">
                                                    Nazwa
                                                </p>
                                                <p class="text-sm md:text-xl text-gray-900 dark:text-gray-50 font-semibold">
                                                    <a href="{{route('setting')}}" class="text-blue-300 dark:text-blue-400 hover:underline">
                                    ...
                                    <li>
                                        <div class="relative flex flex-col gap-4 w-full h-full appearance-none rounded-lg  border-2 border-white dark:border-gray-700 p-4 outline-none  dark:text-gray-50">
                                            <div class="md:grid md:gap-4 py-4 ">
                                                <button id="client_data_set" type="button" class="top-3 right-4 absolute inline-flex items-center px-4 py-2 bg-gray-100 dark:bg-gray-200 border border-transparent rounded-lg font-semibold text-sm text-gray-700 dark:text-gray-900 uppercase tracking-widest hover:bg-gray-700 hover:text-white dark:hover:bg-gray-300 dark:hover:text-gray-700 focus:bg-gray-700 focus:text-white dark:focus:bg-gray-300 active:bg-gray-900 dark:active:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                                                    <i class="fa-solid fa-gears"></i>
                                                </button>
                                                <!-- Klient -->
                                                <div class="mb-6">
                            ...
                            <div id="client_data" class="hidden">
                                <div class="flex flex-row justify-between gap-4 mb-6 w-full mt-4">
                                    <h1 class="text-2xl font-medium text-gray-700 dark:text-gray-100">
                                        Zmień ustawienia wyszukiwarki NIP
                                    </h1>
                                </div>
                                <ul class="grid w-full gap-6 md:grid-cols-3">
                                    <li>
                                        <input
                                            @if($set_client=='domyslna' )
                                            checked
                                            @endif
                                            name="setting_client" type="radio" id="default" value="domyslna" class="hidden peer">
                                        <label for="default" class="text-center h-full flex flex-col gap-4 items-center justify-between w-full p-5 text-gray-400 bg-white border-2 border-gray-100 rounded-lg cursor-pointer peer-checked:text-gray-700 peer-checked:bg-gray-100 peer-checked:border-blue-500 hover:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 peer-checked:dark:border-blue-600 dark:hover:text-gray-50 dark:peer-checked:text-gray-50 dark:peer-checked:bg-gray-700">
                                            <span class="w-full text-sm md:text-xl font-semibold"><span class="text-indigo-300 dark:text-indigo-300 uppercase transition ease-in-out duration-150">Domyślna</span></span>
                                            ...
                                            <p class="text-green-500 dark:text-green-500"> </p>
                                        </label>
                                    </li>
                                    <li>
                                        <input
                                            ...
                                            checked
                                            @endif
                                            name="setting_client" type="radio" id="gus1" value="gus" class="hidden peer">
                                        <label for="gus1" class="text-center h-full flex flex-col gap-4 items-center justify-between w-full p-5 text-gray-400 bg-white border-2 border-gray-100 rounded-lg cursor-pointer peer-checked:text-gray-700 peer-checked:bg-gray-100 peer-checked:border-blue-500 hover:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 peer-checked:dark:border-blue-600 dark:hover:text-gray-50 dark:peer-checked:text-gray-50 dark:peer-checked:bg-gray-700">
                                            <span class="w-full text-sm md:text-xl font-semibold">DOMYŚLNA + <span class="text-indigo-300 dark:text-indigo-300 uppercase transition ease-in-out duration-150">GUS</span></span>
                                            <p>Na podstawie numeru NIP system zaciąga dane z ogólnodostępnej bazy danych GUS</p>
                                            <span class="w-full text-sm md:text-xl font-semibold"></span>
                                            <p class="text-green-500 dark:text-green-500">Rekomendowane</p>
                                        </label>
                                    </li>
                                    <li>
                                        <input
                                            ...
                                            checked
                                            @endif
                                            name="setting_client" type="radio" id="kas1" value="kas" class="hidden peer">
                                        <label for="kas1" class="text-center h-full flex flex-col gap-4 items-center justify-between w-full p-5 text-gray-400 bg-white border-2 border-gray-100 rounded-lg cursor-pointer peer-checked:text-gray-700 peer-checked:bg-gray-100 peer-checked:border-blue-500 hover:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 peer-checked:dark:border-blue-600 dark:hover:text-gray-50 dark:peer-checked:text-gray-50 dark:peer-checked:bg-gray-700">
                                            <span class="w-full text-sm md:text-xl font-semibold">DOMYŚLNA + <span class="text-indigo-300 dark:text-indigo-300 uppercase transition ease-in-out duration-150">KAS</span></span>
                                ...
                                <div class="text-sm text-center text-gray-700 dark:text-gray-500 mb-2">System pamięta zawsze ostatni wybór</div>
                                <div class="w-full rounded-lg max-w-4xl mx-auto flex flex-row gap-4 items-center justify-center">
                                    <button type="button" id="client_data_done"
                                        class=" inline-flex items-center px-4 py-2 bg-green-300 dark:bg-green-200 border border-transparent rounded-md font-semibold text-lg text-white dark:text-green-800 uppercase tracking-widest hover:bg-green-700 dark:hover:bg-green-300 focus:bg-green-700 dark:focus:bg-green-300 active:bg-green-900 dark:active:bg-green-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-green-800 transition ease-in-out duration-150">
                                        <i class="fa-solid fa-check mr-2"></i>Gotowe
                                    </button>
                                </div>
                            ...
                            <div class="mb-6 relative">
                                <button id="items_data_set" type="button" class="top-0 right-0 absolute inline-flex items-center px-4 py-2 bg-gray-100 dark:bg-gray-200 border border-transparent rounded-lg font-semibold text-sm text-gray-700 dark:text-gray-900 uppercase tracking-widest hover:bg-gray-700 hover:text-white dark:hover:bg-gray-300 dark:hover:text-gray-700 focus:bg-gray-700 focus:text-white dark:focus:bg-gray-300 active:bg-gray-900 dark:active:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                                    <i class="fa-solid fa-gears"></i>
                                </button>
                                ...
                                <div id="invoice-items" class="mt-6">
                                    ...
                                    <div class="invoice-item grid grid-cols-1 md:grid-cols-12 gap-4 mb-4">
                                        <div class="col-span-11 h-full w-full grid grid-cols-1 lg:grid-cols-8 gap-4 mb-4 justify-center items-end text-center">
                                    ...
                                    <div id="items-set" class=" mb-4">
                                        <div class="mt-2 bg-yellow-100 border border-yellow-200 text-sm text-yellow-800 rounded-lg p-4 dark:bg-yellow-800 dark:border-yellow-900 dark:text-yellow-500" role="alert" tabindex="-1" aria-labelledby="hs-soft-color-warning-label">
                                            <span id="hs-soft-color-warning-label" class="font-bold">Uwaga! </span>Tymczasowo ustawienia pozycji niedostępne. Moliwy tylko podgąd domyślnych ustwień
                                        </div>
                                        <div class="flex flex-row justify-between gap-4 mb-6 w-full mt-4">
                                            <h1 class="text-2xl font-medium text-gray-700 dark:text-gray-100">
                                                Zmień domyślne stawki VAT'u
                                            </h1>
                                        </div>
                                        <ul class="grid w-full gap-6 md:grid-cols-4">
                                            <li>
                                                <input disabled
                                                    name="vat" type="radio" id="0" value="default" class="hidden peer">
                                                <label for="0" class="text-center h-full flex flex-col gap-4 items-center justify-between w-full p-5 text-gray-400 bg-white border-2 border-gray-100 rounded-lg cursor-pointer peer-checked:text-gray-700 peer-checked:bg-gray-100 peer-checked:border-blue-500 hover:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 peer-checked:dark:border-blue-600 dark:hover:text-gray-50 dark:peer-checked:text-gray-50 dark:peer-checked:bg-gray-700">
                                                    <span class="w-full text-sm md:text-xl font-semibold"><span class="text-indigo-300 dark:text-indigo-300 uppercase transition ease-in-out duration-150">0%</span></span>
                                                    <p class="text-green-500"> </p>
                                                </label>
                                            </li>
                                            <li>
                                                <input disabled
                                                    name="vat" type="radio" id="5" value="gus" class="hidden peer">
                                                <label for="5" class="text-center h-full flex flex-col gap-4 items-center justify-between w-full p-5 text-gray-400 bg-white border-2 border-gray-100 rounded-lg cursor-pointer peer-checked:text-gray-700 peer-checked:bg-gray-100 peer-checked:border-blue-500 hover:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 peer-checked:dark:border-blue-600 dark:hover:text-gray-50 dark:peer-checked:text-gray-50 dark:peer-checked:bg-gray-700">
                                                    <span class="w-full text-sm md:text-xl font-semibold"><span class="text-indigo-300 dark:text-indigo-300 uppercase transition ease-in-out duration-150">5%</span></span>
                                                    <p class="text-green-500"> </p>
                                                </label>
                                            </li>
                                            <li>
                                                <input disabled
                                                    name="vat" type="radio" id="8" class="hidden peer">
                                                <label for="8" class="text-center h-full flex flex-col gap-4 items-center justify-between w-full p-5 text-gray-400 bg-white border-2 border-gray-100 rounded-lg cursor-pointer peer-checked:text-gray-700 peer-checked:bg-gray-100 peer-checked:border-blue-500 hover:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 peer-checked:dark:border-blue-600 dark:hover:text-gray-50 dark:peer-checked:text-gray-50 dark:peer-checked:bg-gray-700">
                                                    <span class="w-full text-sm md:text-xl font-semibold"><span class="text-indigo-300 dark:text-indigo-300 uppercase transition ease-in-out duration-150">8%</span></span>
                                                    <p class="text-green-500"> </p>
                                                </label>
                                            </li>
                                            <li>
                                                <input checked disabled
                                                    name="vat" type="radio" id="23" class="hidden peer">
                                                <label for="23" class="text-center h-full flex flex-col gap-4 items-center justify-between w-full p-5 text-gray-400 bg-white border-2 border-gray-100 rounded-lg cursor-pointer peer-checked:text-gray-700 peer-checked:bg-gray-100 peer-checked:border-blue-500 hover:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 peer-checked:dark:border-blue-600 dark:hover:text-gray-50 dark:peer-checked:text-gray-50 dark:peer-checked:bg-gray-700">
                                                    <span class="w-full text-sm md:text-xl font-semibold"><span class="text-indigo-300 dark:text-indigo-300 uppercase transition ease-in-out duration-150">23%</span></span>
                                                    <p class="text-green-500 dark:text-green-500">Najczęściej używane</p>
                                                </label>
                                            </li>
                                        </ul>
                                        <div class="flex flex-row justify-between gap-4 mb-6 w-full mt-4">
                                            <h1 class="text-2xl font-medium text-gray-700 dark:text-gray-100">
                                                Zmień ustawienia wpisywania ceny i VAT'u
                                            </h1>
                                        </div>
                                        <ul class="grid w-full gap-6 md:grid-cols-2">
                                            <li>
                                                <input disabled checked
                                                    name="vatprice" type="radio" id="netvat" value="netvat" class="hidden peer">
                                                <label for="netvat" class="text-center h-full flex flex-col gap-4 items-center justify-between w-full p-5 text-gray-400 bg-white border-2 border-gray-100 rounded-lg cursor-pointer peer-checked:text-gray-700 peer-checked:bg-gray-100 peer-checked:border-blue-500 hover:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 peer-checked:dark:border-blue-600 dark:hover:text-gray-50 dark:peer-checked:text-gray-50 dark:peer-checked:bg-gray-700">
                                                    <span class="w-full text-sm md:text-xl font-semibold"><span class="text-indigo-300 dark:text-indigo-300 uppercase transition ease-in-out duration-150">WPISZ CENĘ NETTO + VAT</span></span>
                                                </label>
                                            </li>
                                            <li>
                                                <input disabled
                                                    name="vatprice" type="radio" id="brutvat" value="brutvat" class="hidden peer">
                                                <label for="brutvat" class="text-center h-full flex flex-col gap-4 items-center justify-between w-full p-5 text-gray-400 bg-white border-2 border-gray-100 rounded-lg cursor-pointer peer-checked:text-gray-700 peer-checked:bg-gray-100 peer-checked:border-blue-500 hover:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 peer-checked:dark:border-blue-600 dark:hover:text-gray-50 dark:peer-checked:text-gray-50 dark:peer-checked:bg-gray-700">
                                                    <span class="w-full text-sm md:text-xl font-semibold"><span class="text-indigo-300 dark:text-indigo-300 uppercase transition ease-in-out duration-150">WPISZ CENĘ BRUTTO - VAT</span></span>
                                                </label>
                                            </li>
                                        </ul>
                                        <div class="text-sm text-center text-gray-700 dark:text-gray-500 mb-2">System pamięta zawsze ostatni wybór</div>
                                        <div class="w-full rounded-lg max-w-4xl mx-auto flex flex-row gap-4 items-center justify-center">
                                            <button type="button" id="items_done"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="md:col-span-1">
                                            <div id="summary" class="flex flex-col gap-4 w-full appearance-none rounded-lg border border-white dark:border-gray-700 bg-white p-4 outline-none  dark:bg-gray-700 dark:text-gray-50">
                                ...
                                <div class="mb-6">
                                    ...
                                    <ul class="grid w-full gap-6 md:grid-cols-2">
                                        <li>
                                            <input name="paid" type="radio" id="paid" value="opłacono" class="hidden peer" checked>
                                        ...
                                        <li>
                                            <input name="paid" type="radio" id="paid_part" value="opłacono częściowo" class="hidden peer">
                                ...
                                <div class="w-full rounded-lg max-w-4xl mx-auto flex flex-col md:flex-row gap-4 items-center justify-center">
                                    ...
                                    <button type="submit" class="whitespace-nowrap inline-flex items-center px-4 py-2 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-lg font-semibold text-lg text-white dark:text-gray-900 uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-gray-300 focus:bg-gray-700 dark:focus:bg-gray-300 active:bg-gray-900 dark:active:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
