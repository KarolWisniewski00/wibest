                ...
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <form method="POST" action="{{ route('product.update', $product->id) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" id="magazine" name="magazine" step="1" value="{{ old('magazine', $product->magazine) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">
                            @error('magazine')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
